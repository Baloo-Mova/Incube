        ...
        <div class="item  col-xs-4 col-lg-4">
         ...
         <div class="item  col-xs-4 col-lg-4">
            <div class="thumbnail">
                ...
                <div class="caption">
                    <h4 class="group inner list-group-item-heading">
                        <a href="#"> Інвестиційниї проект зі створення навчально-науково-виробничої лабораторії з відтворення водних біоресурсів верхів'я Каховського водосховища</a></h4>
                    <hr/>
                    <p class="group inner list-group-item-text">
