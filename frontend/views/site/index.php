...
<div class="container">
    ...
    <div id="custom_carousel" class="carousel slide odd wow fadeInUp" data-wow-delay="1s" data-ride="carousel" data-interval="3000">
        ...
        <div class="controls">
            <ul class="nav">
                <?php
                    ...
                    foreach ($tmp as $i => $key) {
                        ?>
                <li data-target="#custom_carousel" data-slide-to="<?=$key->id-1?>" class="<?php if($key->id-1==0) echo 'active';?>"><a href="#"><img src="../img/projects_img/<?= $key->id ?>.jpg" style="width: 50px; height: 50px;"><small><?=$key->project_name;?></small></a></li>
                    <?php }?>
