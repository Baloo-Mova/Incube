...
<div class="row content">
    ...
    <p>Якщо Ви шукаєте роботу - запонвіть наступну заявку: </p>
          ...
          <div class="row">
            <div class="aa-popular-category-area">
             ...
             <ul class="nav nav-tabs aa-products-tab">
                <li class="active"><a href="#popular" data-toggle="tab">Запроновані проекти</a></li>
                <li><a href="#featured" data-toggle="tab">Проекти на реалізацію</a></li>
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane fade in active" id="popular">
                  ...
                  <a class="btn btn-success btn-lg" href="#">Усі запровоновані проекти <span class="fa fa-long-arrow-right"></span></a>
                </div>
