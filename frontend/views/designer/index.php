...
<div class="row content">
    ...
    <div class="text-center">
        <a href="<?= \yii\helpers\Url::to(Yii::$app->urlManager->baseUrl . '/designer/create') ?>" class="btn btn-lg btn-danger center">Подати заявку <span class="glyphicon glyphicon-chevron-right"></span></a>
    </div>
